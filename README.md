# 🎯 PrepIt – AI-Driven Interview Preparation Platform

> **Practice job interviews with AI-powered feedback and voice interaction**

PrepIt is a cutting-edge interview preparation platform that combines **Next.js 15**, **TypeScript**, **Firebase**, and **Google Gemini AI** to deliver realistic mock interviews with instant feedback. Practice with voice-based AI interviews and get detailed performance analysis to ace your next job interview.
...
5. **Open your browser**
   ...
   Navigate to [http://localhost:3000](http://localhost:3000) to see PrepIt in action!
...
- Contact us at [support@prepit.ai](mailto:support@prepit.ai)
